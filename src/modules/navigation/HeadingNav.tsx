...
interface HeadingNavProps extends React.ComponentProps<typeof Flex> {
	ref?: React.Ref<HTMLDivElement>
	header?: boolean
}

function HeadingNav({ className, style, header = true, ref, ...rest }: HeadingNavProps) {
								...
								return (
									...
									>
										...
										>
											<Text
												variant={
													isActive ? 'body-strong-s' : 'body-default-s'
												}
												truncate
												style={{
