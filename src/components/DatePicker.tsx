...
// Type for window with dropdown tracking
type WindowWithDropdown = Window & { lastOpenedDropdown?: string | null };
      ...
      days.push(
        ...
        >
          <Button
            ...
            variant="tertiary"
            radius={
              firstDay === 1 ? undefined : i === 0 ? "left" : i === firstDay - 1 ? "right" : "none"
            }
            size={size}
            type="button"
            disabled
      ...
      days.push(
        ...
        >
          <Button
            ...
            onMouseEnter={(_e: React.MouseEvent<HTMLButtonElement>) => {
              onHover?.(currentDate);
              ...
              <Row gap="4" horizontal="center">
                <DropdownWrapper
                  ...
                  onOpenChange={(open) => {
                    ...
                    if (open) {
                      ...
                      (window as WindowWithDropdown).lastOpenedDropdown = "month-dropdown";
                    } else if (
                      (window as WindowWithDropdown).lastOpenedDropdown === "month-dropdown"
                    ) {
                      (window as WindowWithDropdown).lastOpenedDropdown = null;
                    }
                  }}
                  trigger={
                    <Button
                ...
                <DropdownWrapper
                  ...
                  onOpenChange={(open) => {
                    ...
                    if (open) {
                      // Set this as the last opened dropdown
                      (window as WindowWithDropdown).lastOpenedDropdown = "year-dropdown";
                    } else if (
                      (window as WindowWithDropdown).lastOpenedDropdown === "year-dropdown"
                    ) {
                      (window as WindowWithDropdown).lastOpenedDropdown = null;
