	...
	const renderCalendarGrid = () => {
		...
		for (let day = 1; day <= daysInMonth; day++) {
			...
			if (isDisabled) {
				...
				const totalConsecutiveDisabled =
					consecutiveDisabledEnd - consecutiveDisabledStart + 1
								...
								<DropdownWrapper
									...
									onOpenChange={(open) => {
										...
										if (open) {
											...
											;(window as WindowWithDropdown).lastOpenedDropdown =
												'month-dropdown'
										} else if (
											(window as WindowWithDropdown).lastOpenedDropdown ===
											'month-dropdown'
