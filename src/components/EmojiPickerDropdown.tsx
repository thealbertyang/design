...
export interface EmojiPickerDropdownProps extends Omit<
	React.ComponentProps<typeof DropdownWrapper>,
	'dropdown'
> {
		...
		<DropdownWrapper
			...
			dropdown={
				<EmojiPicker
					...
					onClose={
						closeAfterClick ? () => dropdownProps.onOpenChange?.(false) : undefined
					}
