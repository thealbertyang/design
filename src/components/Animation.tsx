					...
					{isActive &&
						...
						createPortal(
							<Flex
								...
								zIndex={10}
								paddingTop={
									finalPlacement.includes('bottom') ? offsetDistance : undefined
								}
								paddingBottom={
									finalPlacement.includes('top') ? offsetDistance : undefined
								}
								paddingLeft={
									finalPlacement.includes('right') ? offsetDistance : undefined
								}
								paddingRight={
									finalPlacement.includes('left') ? offsetDistance : undefined
								}
								style={{
									position: strategy,
									top: y ?? 0,
								...
								onMouseEnter={
									triggerType === 'hover' ? handleMouseEnter : undefined
								}
								onMouseLeave={
									triggerType === 'hover' ? handleMouseLeave : undefined
								}
		...
		return (
			...
			>
				...
				<Flex
					...
					onMouseEnter={
						triggerType === 'hover' && isActive ? handleMouseEnter : undefined
					}
					aria-hidden={!isActive}
